...
import com.bofa.exception.EmployeeNotFoundException;
...
public class EmployeeServiceImpl implements EmployeeService{
    ...
    public Employee getEmployee(Long employeeId){
        return EmpRepo.findById(employeeId).orElseThrow(()-> new EmployeeNotFoundException("employee with id"+employeeId+" not found"));
    }
    @Override
